...
alter table "public"."project_tags" add constraint "solid_color_hex" CHECK (((color ~* '^#[a-f0-9]{2}[a-f0-9]{2}[a-f0-9]{2}$'::text) AND (label_color ~* '^#[a-f0-9]{2}[a-f0-9]{2}[a-f0-9]{2}$'::text))) not valid;

alter table "public"."project_tags" validate constraint "solid_color_hex";
