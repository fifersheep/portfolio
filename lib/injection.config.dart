...
import 'package:portfolio/data/network/projects/supabase_projects_repository.dart' as _i11;
...
import 'package:portfolio/presentation/core/navigation/navigation_route_observer.dart' as _i8;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i8.NavigationRouteObserver>(() => _i8.NavigationRouteObserver());
    gh.lazySingleton<_i9.NewLineFormatter>(() => _i9.NewLineFormatter());
    gh.lazySingleton<_i10.ProjectsRepository>(() => _i11.SupabaseProjectsRepository(gh<_i3.Api>()));
    ...
    gh.lazySingleton<_i13.ProjectsBloc>(() => _i13.ProjectsBloc(gh<_i10.ProjectsRepository>()));
    return this;
  }
}
