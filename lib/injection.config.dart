...
_i1.GetIt $initGetIt(_i1.GetIt get, {String? environment, _i2.EnvironmentFilter? environmentFilter}) {
  ...
  gh.lazySingleton<_i4.ExperienceParser<_i5.DocumentSnapshot<Object?>>>(() => _i6.FirestoreExperienceParser());
  ...
  gh.lazySingleton<_i9.ProjectParser<_i5.DocumentSnapshot<Object?>>>(() => _i10.FirestoreProjectParser());
  gh.lazySingleton<_i11.ProjectsRepository>(() => _i12.FirestoreProjectsRepository(
      get<_i5.FirebaseFirestore>(), get<_i9.ProjectParser<_i5.DocumentSnapshot<Object?>>>()));
  gh.lazySingleton<_i13.ExperiencesRepository>(() => _i14.FirestoreExperiencesRepository(
      get<_i5.FirebaseFirestore>(), get<_i4.ExperienceParser<_i5.DocumentSnapshot<Object?>>>()));
