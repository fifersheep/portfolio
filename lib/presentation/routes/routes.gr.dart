...
class Router extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    IntroRoute.name: (routeData) {
      return _i1.MaterialPageX<dynamic>(routeData: routeData, child: _i3.IntroPage());
    },
    ProjectsRoute.name: (routeData) {
      return _i1.MaterialPageX<dynamic>(routeData: routeData, child: _i4.ProjectsPage());
    },
    ProjectDetailsRoute.name: (routeData) {
      ...
      return _i1.MaterialPageX<dynamic>(routeData: routeData, child: _i5.ProjectDetailsPage(id: args.id));
    },
    ExperiencesRoute.name: (routeData) {
      return _i1.MaterialPageX<dynamic>(routeData: routeData, child: _i6.ExperiencesPage());
    },
    BlogRoute.name: (routeData) {
      return _i1.MaterialPageX<dynamic>(routeData: routeData, child: _i7.BlogPage());
    },
    RouteNotFound.name: (routeData) {
      return _i1.MaterialPageX<dynamic>(routeData: routeData, child: _i8.PageNotFound());
    }
  };
